...
// âââ STATUTS âââââââââââââââââââââââââââââââââââââââââââââââââ
const STATUTS_ORDER = [
  "Soumise", "AffectÃ©e", "En attente de piÃ¨ces",
  "ComplÃ¨te", "PrÃªte pour la commission", "PrÃªte pour la session", "FermÃ©e"
];

const STATUS_STYLES = {
  "Soumise":                  { bg: "#E8F4FD", color: "#0070D2" },
  "AffectÃ©e":                 { bg: "#EAF5EA", color: "#2E7D32" },
  "En attente de piÃ¨ces":     { bg: "#FFF3E0", color: "#E65100" },
  "ComplÃ¨te":                 { bg: "#E3F2FD", color: "#1565C0" },
  "PrÃªte pour la commission": { bg: "#F3E5F5", color: "#6A1B9A" },
  "PrÃªte pour la session":    { bg: "#E8F5E9", color: "#1B5E20" },
  "FermÃ©e":                   { bg: "#F5F5F5", color: "#616161" },
  "FermÃ©":                    { bg: "#F5F5F5", color: "#616161" },
};
...
// âââ COMPLETE DEMANDES DATA âââââââââââââââââââââââââââââââââââ
const DEMANDES_DATA = [
  { id:"000001", type:"Inscription au stage",              stagiaire:"DUPONT Marie",      statut:"PrÃªte pour la commission", typeStage:"Stage classique",                         cycle:"AnnÃ©e 1", mois:"12/36", cabinet:"Cabinet Mazars",      maitre:"BERNARD Jacques",   controleur:"LEROY Sophie",   dateEffet:"01/04/2026", dateSession:"15/03/2026" },
  { id:"000002", type:"DÃ©clarer/Modifier un MaÃ®tre de stage", stagiaire:"MARTIN Lucas",  statut:"AffectÃ©e",                  typeStage:"Stage avec rÃ©duction",                    cycle:"AnnÃ©e 2", mois:"8/24",  cabinet:"KPMG France",         maitre:"ROUX Philippe",     controleur:"MOREAU Alice",   dateEffet:"15/02/2026", dateSession:"20/04/2026" },
  { id:"000003", type:"DÃ©clarer un changement administratif", stagiaire:"PETIT Camille", statut:"ComplÃ¨te",                  typeStage:"Stage d'un an / Renouvellement AFS",      cycle:"AnnÃ©e 1", mois:"10/12", cabinet:"Deloitte & AssociÃ©s", maitre:"FOURNIER Marc",     controleur:"GIRARD Isabelle",dateEffet:"10/03/2026", dateSession:"05/05/2026" },
  { id:"000004", type:"Inscription au stage",              stagiaire:"LEFEVRE Thomas",    statut:"En attente de piÃ¨ces",     typeStage:"Stage d'un an / Renouvellement AFS",      cycle:"AnnÃ©e 1", mois:"8/12",  cabinet:"EY France",           maitre:"DURAND Alain",      controleur:"LAMBERT Claire", dateEffet:"01/03/2026", dateSession:"10/04/2026" },
  { id:"000005", type:"ArrÃªter un stage (suspension/abandon)", stagiaire:"GARCIA Elena", statut:"Soumise",                   typeStage:"Stage classique",                         cycle:"AnnÃ©e 2", mois:"6/36",  cabinet:"PwC France",          maitre:"SIMON Pierre",      controleur:"MERCIER Nicolas",dateEffet:"20/02/2026", dateSession:"15/05/2026" },
  { id:"000006", type:"Demander une prorogation AFS",      stagiaire:"ROBERT Julien",     statut:"FermÃ©e",                   typeStage:"Stage avec rÃ©duction",                    cycle:"AnnÃ©e 3", mois:"20/24", cabinet:"Grant Thornton",      maitre:"DUBOIS GÃ©rard",     controleur:"FONTAINE Ãlodie",dateEffet:"01/01/2026", dateSession:"01/03/2026" },
  { id:"000007", type:"Inscription au stage",              stagiaire:"MOREL Claire",       statut:"PrÃªte pour la session",   typeStage:"Stage classique",                         cycle:"AnnÃ©e 1", mois:"3/36",  cabinet:"BDO France",          maitre:"LAURENT Michel",    controleur:"CHEVALIER Paul", dateEffet:"01/05/2026", dateSession:"20/06/2026" },
  { id:"000008", type:"DÃ©clarer/Modifier un MaÃ®tre de stage", stagiaire:"LAMBERT Hugo",   statut:"AffectÃ©e",                 typeStage:"Stage d'un an / Renouvellement AFS",      cycle:"AnnÃ©e 1", mois:"9/12",  cabinet:"RSM France",          maitre:"BONNET Yves",       controleur:"ROBIN Ãlodie",   dateEffet:"15/03/2026", dateSession:"01/05/2026" },
  { id:"000009", type:"Inscription au stage",              stagiaire:"BONNET LÃ©a",         statut:"En attente de piÃ¨ces",    typeStage:"Stage d'un an / Renouvellement AFS",      cycle:"AnnÃ©e 1", mois:"10/12", cabinet:"Fiducial Expertise",  maitre:"LEMAIRE Bruno",     controleur:"GARNIER Sophie", dateEffet:"01/04/2026", dateSession:"15/05/2026" },
  { id:"000010", type:"DÃ©clarer un changement administratif", stagiaire:"MERCIER Antoine",statut:"ComplÃ¨te",                 typeStage:"Stage avec rÃ©duction",                    cycle:"AnnÃ©e 1", mois:"16/24", cabinet:"Crowe Horwath",       maitre:"PERRIN Jean-Luc",   controleur:"BLANC ValÃ©rie",  dateEffet:"20/03/2026", dateSession:"10/04/2026" },
  { id:"000011", type:"ArrÃªter un stage (suspension/abandon)", stagiaire:"CHEVALIER Sarah",statut:"Soumise",                 typeStage:"Stage classique",                         cycle:"AnnÃ©e 2", mois:"9/36",  cabinet:"Mazars SA",           maitre:"HENRY FranÃ§ois",    controleur:"ROUSSEAU Martin",dateEffet:"10/02/2026", dateSession:"20/05/2026" },
  { id:"000012", type:"Inscription au stage",              stagiaire:"DURAND Ãmilie",      statut:"PrÃªte pour la commission",typeStage:"Stage d'un an / Renouvellement AFS",      cycle:"AnnÃ©e 1", mois:"11/12", cabinet:"In Extenso",          maitre:"MASSON Thierry",    controleur:"ANDRE Paul",     dateEffet:"01/04/2026", dateSession:"15/03/2026" },
  { id:"000013", type:"Demander une prorogation AFS",      stagiaire:"FONTAINE Romain",    statut:"FermÃ©e",                  typeStage:"Stage d'un an / Renouvellement AFS",      cycle:"AnnÃ©e 1", mois:"5/12",  cabinet:"Nexia France",        maitre:"GIRAUD Dominique",  controleur:"FAURE HÃ©lÃ¨ne",   dateEffet:"01/01/2026", dateSession:"01/02/2026" },
  { id:"000014", type:"Inscription au stage",              stagiaire:"ROBIN Maxime",       statut:"Soumise",                 typeStage:"Stage classique",                         cycle:"AnnÃ©e 2", mois:"22/36", cabinet:"Baker Tilly France",  maitre:"MULLER Patrick",    controleur:"LECOMTE Ãdouard",dateEffet:"01/05/2026", dateSession:"15/06/2026" },
  { id:"000015", type:"DÃ©clarer/Modifier un MaÃ®tre de stage", stagiaire:"SIMON ChloÃ©",     statut:"AffectÃ©e",                typeStage:"Stage avec rÃ©duction",                    cycle:"AnnÃ©e 3", mois:"12/24", cabinet:"Groupe Y Nexia",      maitre:"RENAUD Olivier",    controleur:"DAVID Martin",   dateEffet:"20/03/2026", dateSession:"05/05/2026" },
  { id:"000016", type:"DÃ©clarer un changement administratif", stagiaire:"GIRARD Nathan",   statut:"PrÃªte pour la session",   typeStage:"Stage classique",                         cycle:"AnnÃ©e 1", mois:"33/36", cabinet:"Exco France",         maitre:"LEFEBVRE Daniel",   controleur:"THOMAS CÃ©line",  dateEffet:"01/03/2026", dateSession:"10/04/2026" },
  { id:"000017", type:"Inscription au stage",              stagiaire:"ANDRE Manon",        statut:"ComplÃ¨te",                typeStage:"Stage d'un an / Renouvellement AFS",      cycle:"AnnÃ©e 1", mois:"8/12",  cabinet:"Aca Nexia",           maitre:"MOREAU StÃ©phane",   controleur:"PETIT Laurence", dateEffet:"10/04/2026", dateSession:"20/05/2026" },
  { id:"000018", type:"ArrÃªter un stage (suspension/abandon)", stagiaire:"BLANC ThÃ©o",     statut:"En attente de piÃ¨ces",    typeStage:"Stage d'un an / Renouvellement AFS",      cycle:"AnnÃ©e 1", mois:"9/12",  cabinet:"TGS France",          maitre:"GAUTHIER RenÃ©",     controleur:"DENIS FranÃ§ois", dateEffet:"15/03/2026", dateSession:"01/05/2026" },
  { id:"000019", type:"Demander une prorogation AFS",      stagiaire:"FAURE InÃ¨s",         statut:"Soumise",                 typeStage:"Stage avec rÃ©duction",                    cycle:"AnnÃ©e 1", mois:"4/24",  cabinet:"Aplitec",             maitre:"RICHARD Claude",    controleur:"NICOLAS Sylvie", dateEffet:"01/05/2026", dateSession:"10/06/2026" },
  { id:"000020", type:"Inscription au stage",              stagiaire:"HENRY Alexandre",    statut:"AffectÃ©e",                typeStage:"Stage classique",                         cycle:"AnnÃ©e 2", mois:"14/36", cabinet:"Audit France",        maitre:"MARTINEZ Luis",     controleur:"PICARD Monique", dateEffet:"01/04/2026", dateSession:"15/05/2026" },
  { id:"000021", type:"DÃ©clarer/Modifier un MaÃ®tre de stage", stagiaire:"ROUSSEAU OcÃ©ane", statut:"PrÃªte pour la commission",typeStage:"Stage d'un an / Renouvellement AFS",      cycle:"AnnÃ©e 1", mois:"11/12", cabinet:"Cerfrance",           maitre:"VINCENT Georges",   controleur:"HUBERT Corinne", dateEffet:"01/04/2026", dateSession:"15/03/2026" },
  { id:"000022", type:"Inscription au stage",              stagiaire:"THOMAS RaphaÃ«l",     statut:"FermÃ©e",                  typeStage:"Stage d'un an / Renouvellement AFS",      cycle:"AnnÃ©e 1", mois:"7/12",  cabinet:"Exponens",            maitre:"CLEMENT Bernard",   controleur:"MARCHAND Jean",  dateEffet:"01/10/2025", dateSession:"15/01/2026" },
  { id:"000023", type:"DÃ©clarer un changement administratif", stagiaire:"DAVID Lucie",     statut:"Soumise",                 typeStage:"Stage classique",                         cycle:"AnnÃ©e 2", mois:"26/36", cabinet:"Fiteco",              maitre:"BERTRAND Paul",     controleur:"LEGRAND Guy",    dateEffet:"01/05/2026", dateSession:"10/06/2026" },
  { id:"000024", type:"Inscription au stage",              stagiaire:"NICOLAS Kevin",      statut:"PrÃªte pour la session",   typeStage:"Stage avec rÃ©duction",                    cycle:"AnnÃ©e 3", mois:"18/24", cabinet:"Soregor",             maitre:"RENAULT Henri",     controleur:"GUERIN David",   dateEffet:"01/04/2026", dateSession:"15/05/2026" },
  { id:"000025", type:"ArrÃªter un stage (suspension/abandon)", stagiaire:"GUERIN Pauline", statut:"Soumise",                 typeStage:"Stage classique",                         cycle:"AnnÃ©e 1", mois:"2/36",  cabinet:"Groupe Cogesten",     maitre:"POIRIER Jean-Marc", controleur:"AUBERT Michel",  dateEffet:"01/05/2026", dateSession:"20/06/2026" },
  { id:"000026", type:"Demander une prorogation AFS",      stagiaire:"PICARD Bastien",     statut:"ComplÃ¨te",                typeStage:"Stage d'un an / Renouvellement AFS",      cycle:"AnnÃ©e 1", mois:"10/12", cabinet:"Visiativ",            maitre:"BARBIER Christian", controleur:"MEYER Joanne",   dateEffet:"10/03/2026", dateSession:"05/04/2026" },
  { id:"000027", type:"Inscription au stage",              stagiaire:"LEMAIRE Amandine",   statut:"En attente de piÃ¨ces",    typeStage:"Stage d'un an / Renouvellement AFS",      cycle:"AnnÃ©e 1", mois:"11/12", cabinet:"Audit Conseil",       maitre:"COLLET Ãric",       controleur:"PERROT Justin",  dateEffet:"01/04/2026", dateSession:"15/05/2026" },
  { id:"000028", type:"DÃ©clarer/Modifier un MaÃ®tre de stage", stagiaire:"GAUTHIER Ãlodie", statut:"Soumise",                 typeStage:"Stage avec rÃ©duction",                    cycle:"AnnÃ©e 1", mois:"6/24",  cabinet:"Strego",              maitre:"JACQUET Robert",    controleur:"MORIN GeneviÃ¨ve",dateEffet:"01/05/2026", dateSession:"20/06/2026" },
  { id:"000029", type:"Inscription au stage",              stagiaire:"PERRIN Valentin",    statut:"AffectÃ©e",                typeStage:"Stage classique",                         cycle:"AnnÃ©e 2", mois:"11/36", cabinet:"Sofideec Baker Tilly",maitre:"CARPENTIER AndrÃ©",  controleur:"CHARLES Victor", dateEffet:"15/04/2026", dateSession:"30/05/2026" },
  { id:"000030", type:"DÃ©clarer un changement administratif", stagiaire:"DENIS Charlotte", statut:"PrÃªte pour la commission",typeStage:"Stage d'un an / Renouvellement AFS",      cycle:"AnnÃ©e 1", mois:"9/12",  cabinet:"Fiducial Audit",      maitre:"SCHMITT Gilbert",   controleur:"FABRE Christine",dateEffet:"01/04/2026", dateSession:"15/03/2026" },
  { id:"000031", type:"Invalidation partielle",            stagiaire:"DUPONT Marie",        statut:"Soumise",                 typeStage:"Stage classique",                         cycle:"AnnÃ©e 2", mois:"12/36", cabinet:"Cabinet Mazars",      maitre:"BERNARD Jacques",   controleur:"LEROY Sophie",   dateEffet:"01/04/2026", dateSession:"15/04/2026" },
  { id:"000032", type:"DÃ©lai supplÃ©mentaire du stage",     stagiaire:"DUPONT Marie",        statut:"AffectÃ©e",                typeStage:"Stage classique",                         cycle:"AnnÃ©e 2", mois:"12/36", cabinet:"Cabinet Mazars",      maitre:"BERNARD Jacques",   controleur:"LEROY Sophie",   dateEffet:"01/05/2026", dateSession:"15/05/2026" },
  { id:"000033", type:"RÃ©intÃ©gration",                     stagiaire:"DUPONT Marie",        statut:"ComplÃ¨te",                typeStage:"Stage classique",                         cycle:"AnnÃ©e 2", mois:"12/36", cabinet:"Cabinet Mazars",      maitre:"BERNARD Jacques",   controleur:"JACQUET Robert", dateEffet:"01/06/2026", dateSession:"15/06/2026" },
];

// âââ PERSONAL DETAILS PER STAGIAIRE ââââââââââââââââââââââââââ
const PERSON_DETAILS = {
  "DUPONT Marie":      { civ:"Madame",   nom:"DUPONT",    prenom:"Marie",    prenom2:"Claire",    ddn:"15/06/1995", paysNaissance:"France", nationalite:"FranÃ§aise",     lieu:"Paris",      rue:"12 Rue du Faubourg Saint-HonorÃ©", cp:"75008", ville:"Paris",      email:"marie.dupont@gmail.com",      mobile:"+33 6 12 34 56 78", fixe:"+33 1 42 68 53 00" },
  "MARTIN Lucas":      { civ:"Monsieur", nom:"MARTIN",    prenom:"Lucas",    prenom2:"Antoine",   ddn:"22/09/1997", paysNaissance:"France", nationalite:"FranÃ§aise",     lieu:"Lyon",       rue:"45 Rue de la RÃ©publique",        cp:"69002", ville:"Lyon",       email:"lucas.martin@outlook.fr",     mobile:"+33 6 23 45 67 89", fixe:"+33 4 72 56 34 12" },
  "PETIT Camille":     { civ:"Madame",   nom:"PETIT",     prenom:"Camille",  prenom2:"",          ddn:"03/03/1998", paysNaissance:"France", nationalite:"FranÃ§aise",     lieu:"Bordeaux",   rue:"8 AllÃ©es de Tourny",             cp:"33000", ville:"Bordeaux",   email:"camille.petit@free.fr",       mobile:"+33 6 34 56 78 90", fixe:"" },
  "LEFEVRE Thomas":    { civ:"Monsieur", nom:"LEFEVRE",   prenom:"Thomas",   prenom2:"",          ddn:"14/11/1996", paysNaissance:"France", nationalite:"FranÃ§aise",     lieu:"Lille",      rue:"22 Rue Nationale",               cp:"59000", ville:"Lille",      email:"thomas.lefevre@gmail.com",    mobile:"+33 6 45 67 89 01", fixe:"+33 3 20 14 22 33" },
  "GARCIA Elena":      { civ:"Madame",   nom:"GARCIA",    prenom:"Elena",    prenom2:"",          ddn:"07/07/1999", paysNaissance:"Espagne", nationalite:"FranÃ§aise",    lieu:"Toulouse",   rue:"3 Place du Capitole",            cp:"31000", ville:"Toulouse",   email:"elena.garcia@laposte.net",    mobile:"+33 6 56 78 90 12", fixe:"" },
  "ROBERT Julien":     { civ:"Monsieur", nom:"ROBERT",    prenom:"Julien",   prenom2:"Marc",      ddn:"29/01/1994", paysNaissance:"France", nationalite:"FranÃ§aise",     lieu:"Nantes",     rue:"15 Rue du Commerce",             cp:"44000", ville:"Nantes",     email:"julien.robert@gmail.com",     mobile:"+33 6 67 89 01 23", fixe:"+33 2 40 89 12 45" },
  "MOREL Claire":      { civ:"Madame",   nom:"MOREL",     prenom:"Claire",   prenom2:"Isabelle",  ddn:"18/04/2000", paysNaissance:"France", nationalite:"FranÃ§aise",     lieu:"Strasbourg", rue:"9 Rue des Grandes Arcades",      cp:"67000", ville:"Strasbourg", email:"claire.morel@sfr.fr",         mobile:"+33 6 78 90 12 34", fixe:"" },
  "LAMBERT Hugo":      { civ:"Monsieur", nom:"LAMBERT",   prenom:"Hugo",     prenom2:"",          ddn:"11/08/1997", paysNaissance:"France", nationalite:"FranÃ§aise",     lieu:"Montpellier",rue:"28 Rue de la Loge",              cp:"34000", ville:"Montpellier",email:"hugo.lambert@orange.fr",      mobile:"+33 6 89 01 23 45", fixe:"" },
  "BONNET LÃ©a":        { civ:"Madame",   nom:"BONNET",    prenom:"LÃ©a",      prenom2:"",          ddn:"25/12/1998", paysNaissance:"France", nationalite:"FranÃ§aise",     lieu:"Nice",       rue:"14 Avenue Jean MÃ©decin",         cp:"06000", ville:"Nice",       email:"lea.bonnet@gmail.com",        mobile:"+33 6 90 12 34 56", fixe:"+33 4 93 88 77 66" },
  "MERCIER Antoine":   { civ:"Monsieur", nom:"MERCIER",   prenom:"Antoine",  prenom2:"Louis",     ddn:"05/05/1995", paysNaissance:"France", nationalite:"FranÃ§aise",     lieu:"Rennes",     rue:"7 Rue Saint-Georges",            cp:"35000", ville:"Rennes",     email:"antoine.mercier@hotmail.fr",  mobile:"+33 6 01 23 45 67", fixe:"" },
  "CHEVALIER Sarah":   { civ:"Madame",   nom:"CHEVALIER", prenom:"Sarah",    prenom2:"",          ddn:"30/09/1999", paysNaissance:"France", nationalite:"FranÃ§aise",     lieu:"Grenoble",   rue:"5 Place Victor Hugo",            cp:"38000", ville:"Grenoble",   email:"sarah.chevalier@gmail.com",   mobile:"+33 6 12 34 56 79", fixe:"" },
  "DURAND Ãmilie":     { civ:"Madame",   nom:"DURAND",    prenom:"Ãmilie",   prenom2:"Sophie",    ddn:"16/02/1997", paysNaissance:"France", nationalite:"FranÃ§aise",     lieu:"Paris",      rue:"34 Rue du Bac",                  cp:"75007", ville:"Paris",      email:"emilie.durand@gmail.com",     mobile:"+33 6 23 45 67 80", fixe:"+33 1 45 22 87 56" },
  "FONTAINE Romain":   { civ:"Monsieur", nom:"FONTAINE",  prenom:"Romain",   prenom2:"",          ddn:"08/06/1993", paysNaissance:"France", nationalite:"FranÃ§aise",     lieu:"Marseille",  rue:"20 La CanebiÃ¨re",                cp:"13001", ville:"Marseille",  email:"romain.fontaine@yahoo.fr",    mobile:"+33 6 34 56 78 91", fixe:"+33 4 91 25 36 47" },
};

// GÃ©nÃ©rer les dÃ©tails manquants de faÃ§on dÃ©terministe
function getPersonDetails(stagiaire) {
  ...
  const isMale = ["Lucas","Thomas","Julien","Hugo","Antoine","Romain","Maxime","Nathan","Alexandre","RaphaÃ«l","Bastien","Valentin","Kevin","ThÃ©o","Romain"].includes(prenom);
  return {
    ...
    cp: "75001",
    ville: "Paris",
    email: `${prenom.toLowerCase().replace(/[Ã©Ã¨Ãª]/g,"e").replace(/[Ã Ã¢]/g,"a")}.${nom.toLowerCase()}@gmail.com`,
    ...
    <div style={{ display:"flex", flexDirection:"column", gap:2, paddingBottom:12, borderBottom:`1px solid ${T.border}`, marginBottom:12 }}>
      ...
      <div style={{ display:"flex", alignItems:"center", gap:6 }}>
        <span style={{ fontSize:13, fontWeight:600, color: link ? T.pepRed : T.textDark }}>
          {value || <span style={{color:T.textLight,fontStyle:"italic",fontWeight:400}}>â</span>}
        </span>
        {editable && (
...
// âââ STATUS PIPELINE âââââââââââââââââââââââââââââââââââââââââ
    ...
    <div style={{ padding:"12px 16px 0", background:T.white }}>
      ...
      <div style={{ padding:"10px 0 12px" }}>
        <button
          ...
          <Check size={14} />
          Marquer Statut comme terminÃ©(e)
        </button>
      </div>
    </div>
  );
...
// âââ INLINE EDIT FIELD (for Examen tab) ââââââââââââââââââââââ
      ...
      <div style={{ flex:1 }}>
        ...
        {editing ? (
          <div style={{ display:"flex", gap:6 }}>
            ...
            />
            <button onClick={() => setEditing(false)} style={{ background:T.blue, color:"white", border:"none", borderRadius:4, padding:"3px 10px", cursor:"pointer", fontSize:12 }}>â</button>
            <button onClick={() => { setEditing(false); setValue(""); }} style={{ background:"#f0f0f0", border:"none", borderRadius:4, padding:"3px 8px", cursor:"pointer", fontSize:12 }}>â</button>
          </div>
        ) : (
...
// âââ SCREEN: LOGIN ââââââââââââââââââââââââââââââââââââââââââââ
  ...
  return (
    <div style={{ display:"flex", minHeight:"100vh", fontFamily:"'Salesforce Sans', system-ui, sans-serif" }}>
      ...
      <div style={{ flex:"0 0 50%", background:"#F3F2F2", display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", padding:40 }}>
        ...
        <div style={{ background:T.white, borderRadius:8, padding:"32px 36px", width:"100%", maxWidth:400, boxShadow:"0 2px 12px rgba(0,0,0,0.08)" }}>
          ...
          <div style={{ marginTop:12, textAlign:"center" }}>
            <a href="#" style={{ color:T.blue, fontSize:13, textDecoration:"none" }}>Mot de passe oubliÃ© ?</a>
          </div>
        </div>
        <div style={{ marginTop:"auto", paddingTop:32, color:T.textLight, fontSize:12 }}>Â© 2026 Salesforce, Inc. Tous droits rÃ©servÃ©s.</div>
      </div>

      {/* Panneau droit â Salesforce banner */}
      <div style={{ flex:1, background:"#032D60", display:"flex", flexDirection:"column", justifyContent:"center", padding:"48px 56px", color:T.white }}>
        <p style={{ fontSize:13, opacity:0.8, marginBottom:12 }}>5â7 mai 2026 | San Diego, CA</p>
        <h1 style={{ fontSize:38, fontWeight:800, lineHeight:1.2, marginBottom:20, maxWidth:500 }}>
          Inscrivez-vous dÃ¨s maintenant Ã  l'Ã©vÃ©nement data et analytics de l'annÃ©e.
        </h1>
        <p style={{ fontSize:15, opacity:0.8, lineHeight:1.6, maxWidth:520, marginBottom:32 }}>
          La confÃ©rence Tableau est de retour, meilleure que jamais. Rejoignez-nous pour plus de trois jours, 300+ sessions, 150+ formations pratiques, du networking et bien plus.
        </p>
...
// âââ SCREEN: DEMANDES LIST ââââââââââââââââââââââââââââââââââââ
function DemandesListScreen({ onOpenRecord }) {
  ...
  const cols = [
    { key:"id",         label:"NÂ° demande",            w:100 },
    { key:"type",       label:"Type d\'enregistrement", w:210 },
    { key:"stagiaire",  label:"Nom du stagiaire",       w:155 },
    { key:"statut",     label:"Statut demande",          w:175 },
    { key:"typeStage",  label:"Type de stage",           w:185 },
    { key:"cycle",      label:"Cycle de stage",          w:105 },
    { key:"mois",       label:"Nb mois",                 w:90  },
    { key:"cabinet",    label:"Nom du cabinet",          w:165 },
    { key:"maitre",     label:"MaÃ®tre de stage",          w:155 },
    { key:"controleur", label:"ContrÃ´leur",              w:145 },
  ];
  ...
  const SortChevron = ({ col }) => {
    ...
    const color = isActive ? T.pepRed : "#9090A0";
    if (isActive && sortDir === "asc") return <ChevronUp size={12} color={color} style={{ flexShrink:0 }} />;
    return <ChevronDown size={12} color={color} style={{ flexShrink:0, opacity: isActive ? 1 : 0.55 }} />;
  };

  return (
    <div style={{ flex:1, display:"flex", flexDirection:"column", overflow:"hidden", background:T.bgGray }}>
      ...
      <div style={{ background:T.white, borderBottom:`1px solid ${T.border}`, flexShrink:0 }}>
        ...
        <div style={{ padding:"14px 20px 0", display:"flex", alignItems:"flex-start", justifyContent:"space-between" }}>
          <div style={{ display:"flex", alignItems:"center", gap:12 }}>
            <div style={{ width:44, height:44, borderRadius:"50%", background:"#FDDDE0", display:"flex", alignItems:"center", justifyContent:"center", flexShrink:0 }}>
              <Briefcase size={20} color={T.pepRed} />
            </div>
            <div>
              <div style={{ fontSize:11, color:T.textLight, fontWeight:500, marginBottom:2, textTransform:"uppercase", letterSpacing:"0.04em" }}>Demandes</div>
              <div style={{ display:"flex", alignItems:"center", gap:6 }}>
                <h1 style={{ margin:0, fontSize:20, fontWeight:700, color:T.textDark, lineHeight:1.2 }}>
          ...
          <div style={{ display:"flex", gap:8, alignItems:"center", paddingTop:4 }}>
            <button style={{
              border:`1px solid ${T.border}`, background:T.white, borderRadius:4,
              padding:"6px 16px", fontSize:13, fontWeight:600, cursor:"pointer",
              color:T.textDark, display:"flex", alignItems:"center", gap:6,
            }}>
              Nouveau
            </button>
            <button style={{
        ...
        <div style={{ padding:"8px 20px 12px", display:"flex", justifyContent:"space-between", alignItems:"center" }}>
          <span style={{ fontSize:12, color:T.textLight }}>
            {filtered.length} Ã©lÃ©ment{filtered.length > 1 ? "s" : ""} â¢ Mis Ã  jour il y a quelques secondes
          </span>
          <div style={{ display:"flex", gap:6, alignItems:"center" }}>
            {/* Search */}
            <div style={{ position:"relative", display:"flex", alignItems:"center" }}>
              <Search size={13} style={{ position:"absolute", left:10, color:T.textLight, pointerEvents:"none" }} />
              <input
                ...
                style={{
                  ...
                  padding:"5px 28px 5px 30px", fontSize:12, width:250, outline:"none",
                  color:T.textDark,
                }}
              />
              {search && (
                <button onClick={() => setSearch("")} style={{ position:"absolute", right:8, background:"none", border:"none", cursor:"pointer", color:T.textLight, display:"flex" }}>
                  <X size={12}/>
                </button>
              )}
            </div>
            {/* Icon buttons */}
            {[
              { icon:<Settings size={14}/>,  title:"ParamÃ¨tres de colonne" },
              { icon:<RefreshCw size={14}/>, title:"Actualiser" },
              { icon:<Pencil size={14}/>,    title:"Modifier" },
            ].map(({ icon, title }) => (
      ...
      <div style={{ flex:1, overflowX:"auto", overflowY:"auto" }}>
        <table style={{ width:"100%", borderCollapse:"collapse", background:T.white, fontSize:13 }}>
          <thead style={{ position:"sticky", top:0, zIndex:10 }}>
            <tr>
              {/* Checkbox col */}
              <th style={{ ...thStyle(), width:40, padding:"9px 12px", textAlign:"center", borderRight:`1px solid ${T.border}` }}>
                <input
                  type="checkbox"
              ...
              {cols.map((c, i) => (
                <th
                  ...
                  style={{
                    ...thStyle(c.key),
                    width: c.w,
                    color: sortCol === c.key ? T.pepRed : "#3E3E3C",
                    borderRight: i === cols.length - 1 ? "none" : `1px solid ${T.border}`,
                  }}
                >
                  <span style={{ display:"flex", alignItems:"center", gap:4 }}>
                    {c.label}
                    <SortChevron col={c.key} />
                  </span>
                </th>
              ))}
              {/* Action col */}
              <th style={{ ...thStyle(), width:44, borderRight:"none", padding:"9px 8px" }} />
            </tr>
          </thead>
          <tbody>
            {filtered.map((d, i) => {
              const isSel = selected.includes(d.id);
              const rowBg = isSel ? "#F0F8FF" : i % 2 === 0 ? T.white : "#FAFAFA";
              return (
                <tr
                  key={d.id}
                  style={{ borderBottom:`1px solid ${T.borderLight}`, background:rowBg, cursor:"pointer" }}
                  onMouseEnter={e => e.currentTarget.style.background = "#F3F8FF"}
                  onMouseLeave={e => e.currentTarget.style.background = rowBg}
                >
                  <td style={{ padding:"8px 12px", textAlign:"center", borderRight:`1px solid ${T.borderLight}` }} onClick={e => e.stopPropagation()}>
                    <input
                      type="checkbox"
                      checked={isSel}
                  ...
                  <td style={{ padding:"9px 12px", borderRight:`1px solid ${T.borderLight}` }}>
                    <button onClick={() => onOpenRecord(d)} style={{ background:"none", border:"none", cursor:"pointer", color:T.pepRed, fontWeight:700, padding:0, fontSize:13, textDecoration:"underline", textDecorationColor:"transparent" }}
                      onMouseEnter={e => e.currentTarget.style.textDecorationColor = T.pepRed}
                      onMouseLeave={e => e.currentTarget.style.textDecorationColor = "transparent"}>
                      {d.id}
                    </button>
                  </td>
                  <td style={{ padding:"9px 12px", color:T.textDark, borderRight:`1px solid ${T.borderLight}`, fontSize:12 }}>{d.type}</td>
                  <td style={{ padding:"9px 12px", borderRight:`1px solid ${T.borderLight}` }}>
                  ...
                  <td style={{ padding:"9px 12px", color:T.textDark, borderRight:`1px solid ${T.borderLight}`, fontSize:12 }}>{d.typeStage}</td>
                  <td style={{ padding:"9px 12px", color:T.textDark, borderRight:`1px solid ${T.borderLight}`, fontSize:12, textAlign:"center" }}>{d.cycle}</td>
                  <td style={{ padding:"9px 12px", color:T.textDark, borderRight:`1px solid ${T.borderLight}`, fontSize:12, textAlign:"center" }}>{d.mois}</td>
                  <td style={{ padding:"9px 12px", borderRight:`1px solid ${T.borderLight}` }}>
                    <span style={{ color:T.pepRed, fontWeight:600, fontSize:12 }}>{d.cabinet}</span>
                  </td>
                  <td style={{ padding:"9px 12px", borderRight:`1px solid ${T.borderLight}` }}>
                    <span style={{ color:T.pepRed, fontWeight:600, fontSize:12 }}>{d.maitre}</span>
                  </td>
                  <td style={{ padding:"9px 12px", borderRight:`1px solid ${T.borderLight}` }}>
                    <span style={{ color:T.pepRed, fontWeight:600, fontSize:12 }}>{d.controleur}</span>
                  </td>
                  {/* Action button */}
                  <td style={{ padding:"9px 8px", textAlign:"center" }} onClick={e => e.stopPropagation()}>
                    <button
                      ...
                      onMouseEnter={e => { e.currentTarget.style.borderColor = T.pepRed; e.currentTarget.style.color = T.pepRed; }}
...
function DemandeDetailScreen({ record, onClose }) {
  const [activeTab, setActiveTab] = useState("DÃ©tails");
  ...
  function advanceStatut() {
    ...
    if (idx < STATUTS_ORDER.length - 1) {
      ...
      setStatut(next);
      setToastMsg(`Statut mis Ã  jour : ${next}`);
      setTimeout(() => setToastMsg(""), 3000);
    }
  }

  const tabs = ["DÃ©tails", "PJ", "Examen"];
  ...
  return (
    <div style={{ flex:1, overflowY:"auto", background:T.bgGray, position:"relative" }}>
      ...
      <div style={{ margin:"12px 16px 24px" }}>
        ...
        {/* ââ DÃTAILS TAB ââ */}
        {activeTab === "DÃ©tails" && (
          <>
            <AccordionSection title="Informations gÃ©nÃ©rales" defaultOpen={false}>
              <FieldGrid fields={[
                ["NÂ° demande", record.id, false, false],
            ...
            <AccordionSection title="Renseignements personnels" defaultOpen={true}>
              <FieldGrid fields={[
                ...
                ["Nom d'usage", ""],
                ["PrÃ©nom", person.prenom, true],
                ["PrÃ©nom 2", person.prenom2],
                ["PrÃ©nom 3", ""],
                ["PrÃ©nom 4", ""],
                ["Date de naissance", person.ddn],
                ["Pays de naissance", person.paysNaissance, true],
                ["NationalitÃ©", person.nationalite],
                ...
                ["TÃ©lÃ©phone mobile", person.mobile],
                ["TÃ©lÃ©phone fixe", person.fixe],
              ]} />
            </AccordionSection>

            <AccordionSection title="DiplÃ´mes" defaultOpen={false}>
              <FieldGrid fields={[
                ["DiplÃ´me principal", "Master CCA â ComptabilitÃ© ContrÃ´le Audit"],
                ["Ãtablissement", "UniversitÃ© Paris Dauphine"],
                ["AnnÃ©e d'obtention", "2022"],
                ["Mention", "Bien"],
              ]} />
            </AccordionSection>
            ...
            <AccordionSection title="Renseignements sur le stage" defaultOpen={false}>
              <FieldGrid fields={[
                ...
                ["Type de stage", record.typeStage],
                ["Date de dÃ©but", record.dateEffet],
                ["DurÃ©e totale", record.mois + " mois"],
                ["SpÃ©cialitÃ©", "Audit et commissariat aux comptes"],
              ]} />
            </AccordionSection>

            <AccordionSection title="Renseignements sur le(s) MaÃ®tre(s) de stage" defaultOpen={false}>
              <FieldGrid fields={[
                ["MaÃ®tre de stage principal", record.maitre, true],
                ["Titre", "Expert-comptable"],
                ["Cabinet", record.cabinet, true],
                ["ContrÃ´leur de stage", record.controleur, true],
              ]} />
            </AccordionSection>

            <AccordionSection title="PiÃ¨ces justificatives" defaultOpen={false}>
              <div style={{ padding:16, color:T.textLight, fontSize:13 }}>
                Aucune piÃ¨ce justificative associÃ©e Ã  la section DÃ©tails.
              </div>
            </AccordionSection>
            ...
            <AccordionSection title="Confirmation et soumission" defaultOpen={false}>
              <FieldGrid fields={[
                ...
                ["ConfirmÃ© par", record.controleur],
                ["Commentaire", "Dossier complet â en attente de validation commission."],
              ]} />
            </AccordionSection>
          </>
        )}
        ...
        {activeTab === "PJ" && (
          <div style={{ background:T.white, borderRadius:6, border:`1px solid ${T.border}`, padding:48, textAlign:"center", color:T.textLight }}>
            ...
            <p style={{ margin:0, fontSize:14 }}>Aucune piÃ¨ce justificative disponible</p>
          </div>
        )}
          ...
          <>
            <div style={{ background:T.white, borderRadius:6, border:`1px solid ${T.border}`, marginBottom:12, overflow:"hidden" }}>
              ...
              <div style={{ padding:"12px 16px", display:"grid", gridTemplateColumns:"1fr 1fr", gap:"0 32px" }}>
                <EditableField label="Type de commission/comitÃ©" />
                <EditableField label="Avis rÃ©fÃ©rent" />
                <EditableField label="Date de commission/comitÃ©" />
                <EditableField label="Commentaire rÃ©fÃ©rent" />
                <EditableField label="Avis permanent" />
                <EditableField label="Avis commission/comitÃ©" />
                <EditableField label="Commentaire permanent" />
                <EditableField label="Commentaire commission/comitÃ©" />
              </div>
            </div>
...
// âââ PLACEHOLDER SCREEN âââââââââââââââââââââââââââââââââââââââ
        ...
        <div style={{ display:"flex", alignItems:"center", padding:"8px 16px", gap:16 }}>
          ...
          <div style={{ display:"flex", gap:4, alignItems:"center", marginLeft:"auto" }}>
            {[
              ...
              { icon:<Users size={16} />, label:"Ãquipe" },
              { icon:<HelpCircle size={16} />, label:"Aide" },
              { icon:<Settings size={16} />, label:"ParamÃ¨tres" },
